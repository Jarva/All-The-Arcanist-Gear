...
public class AddonSpellBookRenderer extends GeoItemRenderer<AddonSpellBook> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, AddonSpellBook animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int packedColor) {
    ...
    @Override
    public void defaultRender(PoseStack poseStack, AddonSpellBook animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer, float yaw, float partialTick, int packedLight) {
        super.defaultRender(poseStack, animatable, bufferSource, renderType, buffer, yaw, partialTick, packedLight);
    }


    public void defaultRenderGui(PoseStack poseStack, AddonSpellBook animatable, MultiBufferSource bufferSource, @Nullable RenderType renderType, @Nullable VertexConsumer buffer, float yaw, float partialTick, int packedLight, int packedOverlay, int packedColor) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(AddonSpellBook o) {
        return AllTheArcanistGear.prefix( "textures/item/" + o.getConfig().name() + "_spell_book.png");
    }

    @Override
    public RenderType getRenderType(AddonSpellBook animatable, ResourceLocation texture, @org.jetbrains.annotations.Nullable MultiBufferSource bufferSource, float partialTick) {
